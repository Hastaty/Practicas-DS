...
public class Interval implements Observer {
  ...
  public JSONObject toJson()
  {
    ...
    jinterval.put("start", this.getStart());
    jinterval.put("end", this.getEnd());
    jinterval.put("duration", this.getDuration().toSecondsPart());
    jinterval.put("active",this.isActive());
    jinterval.put("parentname", this.getParentTask().getName());
