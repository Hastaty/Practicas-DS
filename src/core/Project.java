...
public class Project extends Activity {
  ...
  public void addActivity(Activity act) {
    ...
    final int last_num = activities.size();
    activities.add(act);
  ...
  public void printInfo() {
    logger.info(fita1, "Project " + getName() + " child of " + ((getParentProject() != null)
            ? getParentProject().getName() : "null")
            + "  " + getInitialDateTime() + "  " + getFinalDateTime()
  ...
  public JSONObject toJson(int depth) {
    ...
    assert jact.get("type").toString() =="Project":"Not a Project";
    ...
    if(depth>0)
    {
      ...
      for(Activity act:this.getActivities())
      {
        ...
        activities.put(act.toJson(new_depth));
      }

    }
    jact.put("activities",activities);
    return jact;
  }
}
